...
<main>
    ...
    <div class="text">
        <p>
            ...
            2022, while February tends to have the lowest ridership. Since 2018,
            each year has seen record-breaking ridership. In August 2022, the
            highest monthly ridership reached almost 700,000 rides, over 200,000
            more than the same period in 2021. Interestingly, the colder months
            (September to December) also showed higher ridership compared to
            previous years. An analysis by <a
                ...
                >Sigli Mumuni</a
            >
            on Toronto's Bikeshare ridership found a positive correlation
            between temperature and ridership, indicating that warmer weather
            leads to increased ridership. The higher ridership between September
            and December 2022 could be attributed to a
            <a
        ...
        <p>
            ...
            resulting in a drop in ridership in April and the lowest ridership
            in May across the five-year period. However, ridership quickly
            bounced back starting in June, and by July 2020, it exceeded the
            ridership of August 2019, the highest month in 2019.
        </p>
    </div>

    <div class="text">
        <p>
            The bikeshare system has been expanding since 2017, with the number
            of stations increasing from 200 to 659 by 2023. The chart below
            illustrates the fast expansion. Before 2020, large expansions would
            occur in July, with many stations installed in either June or July.
            The pace of expansion slowed in 2021, resulting in a relatively
            stable number of stations. In 2022, the expansion occurred
    ...
    <div class="text">
        <p>
            We can also calculate average station usage is by dividing ridership
            by the number of stations. As shown in the chart below, average
            station usage also fluctuates seasonally, mirroring the ridership
            pattern. The lowest usage is typically observed in January or
            February, with fewer than 200 rides started from each station during
            these months. The highest usage was recorded in June 2017, with 1475
            rides per station. In other years (2018 to 2022), the highest
            average station usage occurred in August. The average ridership per
    ...
    <div class="text">
        <p>
            We can also track the growth of the bike-share fleet. Each bike in
            the system is assigned a unique ID. The data shows that the number
            of bikes also fluctuates seasonally, similar to the number of trips
            taken. The highest count of bikes was recorded in August 2020, with
    ...
    <div class="text">
        <p>
            ...
            due to the pandemic lockdown, which resulted in decreased bike share
            usage. Normally, there are 5-6 months where bikes are used more than
            twice per day, and in 2022, bikes were used on average more than 90
            times per month.
        </p>
    </div>
