<script>
	...
	import ChartFunction from '/src/charting/chart.svelte'
...
<ChartFunction labelList = {Month} dataList = {TripCount} colour = grey></ChartFunction>
...
<BarChart data = data variable = "StationCount" yTicks = {yTicks}></BarChart>
